...
hueBoarder = [0.05, 0.075, 0.0888, 0.2, 0.45, 0.72, 0.945, 0.97];
...
repColorTable(4, :) = hsv2rgb([0.98, 0.83, 0.94]);% 赤
repColorTable(5, :) = hsv2rgb([0.07, 0.5, 0.787]);% 茶
repColorTable(6, :) = hsv2rgb([0.07, 0.40, 1]);% 橙
repColorTable(7, :) = hsv2rgb([0.152, 0.45, 0.9]);% 黄
repColorTable(8, :) = hsv2rgb([0.325, 0.7, 0.5]);% 緑
repColorTable(9, :) = hsv2rgb([0.59, 0.70, 0.74]);% 青
repColorTable(10, :) = hsv2rgb([0.95, 0.9, 0.6]);% 紫
repColorTable(11, :) = hsv2rgb([0.96, 0.25, 0.82]);% 桃
...
imwrite(outImg, 'media_06b_C11_2022531047.bmp');% 自分の学籍番号にすること
